...
class m000000_000000_shop_base extends yupe\components\DbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex("ix_{{shop_offer}}_category", '{{shop_offer}}', "category_id", false);
        ...
        $this->addForeignKey("fk_{{shop_offer}}_category",'{{shop_offer}}', 'category_id', '{{category_category}}', 'id', 'SET NULL', 'NO ACTION');
