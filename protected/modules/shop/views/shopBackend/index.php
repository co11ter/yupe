...
$this->breadcrumbs = array(
    ...
    $this->menu = array(
        array('label' => Yii::t('ShopModule.shop', 'Products'), 'items' => array(
            array('icon' => 'list-alt', 'label' => Yii::t('ShopModule.shop', 'Manage products'), 'url' => array('/shop/shopBackend/index')),
